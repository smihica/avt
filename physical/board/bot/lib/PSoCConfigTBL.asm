...
export LoadConfigTBL_bot_Bank1
export LoadConfigTBL_bot_Bank0
export LoadConfigTBL_bot_Ordered
AREA lit(rom, rel)
LoadConfigTBL_bot_Bank0:
...
;       Instance name PWM16_1, Block Name PWM16_LSB(DBB00)
	...
	db		21h, 21h		;PWM16_1_PERIOD_LSB_REG(DBB00DR1)
	db		22h, c5h		;PWM16_1_COMPARE_LSB_REG(DBB00DR2)
;       Instance name PWM16_1, Block Name PWM16_MSB(DBB01)
	db		27h, 00h		;PWM16_1_CONTROL_MSB_REG(DBB01CR0)
	db		25h, 4eh		;PWM16_1_PERIOD_MSB_REG(DBB01DR1)
	db		26h, 09h		;PWM16_1_COMPARE_MSB_REG(DBB01DR2)
...
;       Instance name PWM16_2, Block Name PWM16_LSB(DBB10)
	...
	db		31h, 21h		;PWM16_2_PERIOD_LSB_REG(DBB10DR1)
	db		32h, c5h		;PWM16_2_COMPARE_LSB_REG(DBB10DR2)
;       Instance name PWM16_2, Block Name PWM16_MSB(DBB11)
	db		37h, 00h		;PWM16_2_CONTROL_MSB_REG(DBB11CR0)
	db		35h, 4eh		;PWM16_2_PERIOD_MSB_REG(DBB11DR1)
	db		36h, 09h		;PWM16_2_COMPARE_MSB_REG(DBB11DR2)
;  Instance name PWM16_3, User Module PWM16
;       Instance name PWM16_3, Block Name PWM16_LSB(DBB20)
	db		43h, 00h		;PWM16_3_CONTROL_LSB_REG(DBB20CR0)
	db		41h, 21h		;PWM16_3_PERIOD_LSB_REG(DBB20DR1)
	db		42h, c5h		;PWM16_3_COMPARE_LSB_REG(DBB20DR2)
;       Instance name PWM16_3, Block Name PWM16_MSB(DBB21)
	db		47h, 00h		;PWM16_3_CONTROL_MSB_REG(DBB21CR0)
	db		45h, 4eh		;PWM16_3_PERIOD_MSB_REG(DBB21DR1)
	db		46h, 09h		;PWM16_3_COMPARE_MSB_REG(DBB21DR2)
;  Instance name PWM16_4, User Module PWM16
;       Instance name PWM16_4, Block Name PWM16_LSB(DCB22)
	db		4bh, 00h		;PWM16_4_CONTROL_LSB_REG(DCB22CR0)
	db		49h, 21h		;PWM16_4_PERIOD_LSB_REG(DCB22DR1)
	db		4ah, c5h		;PWM16_4_COMPARE_LSB_REG(DCB22DR2)
;       Instance name PWM16_4, Block Name PWM16_MSB(DCB23)
	db		4fh, 00h		;PWM16_4_CONTROL_MSB_REG(DCB23CR0)
	db		4dh, 4eh		;PWM16_4_PERIOD_MSB_REG(DCB23DR1)
	db		4eh, 09h		;PWM16_4_COMPARE_MSB_REG(DCB23DR2)
...
;       Instance name PWM16_1, Block Name PWM16_MSB(DBB01)
	...
	db		26h, 47h		;PWM16_1_OUTPUT_MSB_REG(DBB01OU)
;  Instance name PWM16_2, User Module PWM16
;       Instance name PWM16_2, Block Name PWM16_LSB(DBB10)
	db		30h, 01h		;PWM16_2_FUNC_LSB_REG(DBB10FN)
	db		31h, 15h		;PWM16_2_INPUT_LSB_REG(DBB10IN)
	db		32h, 40h		;PWM16_2_OUTPUT_LSB_REG(DBB10OU)
;       Instance name PWM16_2, Block Name PWM16_MSB(DBB11)
	db		34h, 21h		;PWM16_2_FUNC_MSB_REG(DBB11FN)
	db		35h, 35h		;PWM16_2_INPUT_MSB_REG(DBB11IN)
	db		36h, 45h		;PWM16_2_OUTPUT_MSB_REG(DBB11OU)
;  Instance name PWM16_3, User Module PWM16
;       Instance name PWM16_3, Block Name PWM16_LSB(DBB20)
	db		40h, 01h		;PWM16_3_FUNC_LSB_REG(DBB20FN)
	db		41h, 15h		;PWM16_3_INPUT_LSB_REG(DBA20IN)
	db		42h, 40h		;PWM16_3_OUTPUT_LSB_REG(DBA20OU)
;       Instance name PWM16_3, Block Name PWM16_MSB(DBB21)
	db		44h, 21h		;PWM16_3_FUNC_MSB_REG(DBB21FN)
	db		45h, 35h		;PWM16_3_INPUT_MSB_REG(DBB21IN)
	db		46h, 47h		;PWM16_3_OUTPUT_MSB_REG(DBB21OU)
;  Instance name PWM16_4, User Module PWM16
;       Instance name PWM16_4, Block Name PWM16_LSB(DCB22)
	db		48h, 01h		;PWM16_4_FUNC_LSB_REG(DCB22FN)
	db		49h, 15h		;PWM16_4_INPUT_LSB_REG(DCB22IN)
	db		4ah, 40h		;PWM16_4_OUTPUT_LSB_REG(DCB22OU)
;       Instance name PWM16_4, Block Name PWM16_MSB(DCB23)
	db		4ch, 21h		;PWM16_4_FUNC_MSB_REG(DCB23FN)
	db		4dh, 35h		;PWM16_4_INPUT_MSB_REG(DCB23IN)
	db		4eh, 44h		;PWM16_4_OUTPUT_MSB_REG(DCB23OU)
;  Instance name UART_1, User Module UART
;       Instance name UART_1, Block Name RX(DCB03)
	db		2ch, 05h		;UART_1_RX_FUNC_REG   (DCB03FN)
	db		2dh, f6h		;UART_1_RX_INPUT_REG  (DCB03IN)
	db		2eh, 40h		;UART_1_RX_OUTPUT_REG (DCB03OU)
;       Instance name UART_1, Block Name TX(DCB02)
	db		28h, 1dh		;UART_1_TX_FUNC_REG   (DCB02FN)
	db		29h, 06h		;UART_1_TX_INPUT_REG  (DCB02IN)
	db		2ah, 45h		;UART_1_TX_OUTPUT_REG (DCB02OU)
;  Instance name UART_2, User Module UART
;       Instance name UART_2, Block Name RX(DCB13)
	db		3ch, 05h		;UART_2_RX_FUNC_REG   (DCB13FN)
	db		3dh, c6h		;UART_2_RX_INPUT_REG  (DCB13IN)
	db		3eh, 40h		;UART_2_RX_OUTPUT_REG (DCB13OU)
;       Instance name UART_2, Block Name TX(DCB12)
	db		38h, 1dh		;UART_2_TX_FUNC_REG   (DCB12FN)
	db		39h, 06h		;UART_2_TX_INPUT_REG  (DCB12IN)
...
;  Global Register values Bank 1
	...
	db		e1h, bch		; OscillatorControl_1 register (OSC_CR1)
	db		e2h, 01h		; OscillatorControl_2 register (OSC_CR2)
	db		dfh, 27h		; OscillatorControl_3 register (OSC_CR3)
...
LoadConfigTBL_bot_Ordered:
;  Ordered Global Register values
	M8C_SetBank0
	mov	reg[00h], 00h		; Port_0_Data register (PRT0DR)
	M8C_SetBank1
	mov	reg[00h], 5fh		; Port_0_DriveMode_0 register (PRT0DM0)
	mov	reg[01h], a0h		; Port_0_DriveMode_1 register (PRT0DM1)
	M8C_SetBank0
	mov	reg[03h], a0h		; Port_0_DriveMode_2 register (PRT0DM2)
	...
	M8C_SetBank1
	mov	reg[08h], a5h		; Port_2_DriveMode_0 register (PRT2DM0)
	mov	reg[09h], 5ah		; Port_2_DriveMode_1 register (PRT2DM1)
	M8C_SetBank0
	mov	reg[0bh], 02h		; Port_2_DriveMode_2 register (PRT2DM2)
	mov	reg[0ah], bdh		; Port_2_GlobalSelect register (PRT2GS)
	M8C_SetBank1
