...
export LoadConfig_bot
export _LoadConfig_bot
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_bot
	lcall	LoadConfigTBL_bot_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration bot
;
;    Load configuration registers for bot.
...
_LoadConfig_bot:
 LoadConfig_bot:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_bot_Bank0
    mov     X, <LoadConfigTBL_bot_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_bot_Bank1
    mov     X, <LoadConfigTBL_bot_Bank1
