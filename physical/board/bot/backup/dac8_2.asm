...
;-----------------------------------------------
export  DAC8_2_Start
export _DAC8_2_Start
export  DAC8_2_SetPower
export _DAC8_2_SetPower

export  DAC8_2_WriteBlind
export _DAC8_2_WriteBlind
export  DAC8_2_WriteBlind2B
export _DAC8_2_WriteBlind2B

export  DAC8_2_WriteStall
export _DAC8_2_WriteStall
export  DAC8_2_WriteStall2B
export _DAC8_2_WriteStall2B
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DAC8_2_Start
;  FUNCTION NAME: DAC8_2_SetPower
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DAC8_2_WriteBlind
;  FUNCTION NAME: DAC8_2_WriteBlind2B
;
;  DESCRIPTION:
...
_DAC8_2_WriteBlind:
  ...
  ENDIF
  IF DAC8_2_OFFSETBINARY | DAC8_2_TWOSCOMPLEMENT
    mov   X, SP
...
BlindMagSet:
    ...
    pop   X
  ENDIF
    or    A, DAC8_2_CR0_HIBITS
    swap  A, X
    or    A, DAC8_2_CR0_HIBITS
    mov   reg[DAC8_2_MSB_CR0], A
    mov   A, X
    mov   reg[DAC8_2_LSB_CR0], A
    RAM_EPILOGUE RAM_USE_CLASS_2
    ret


 DAC8_2_WriteBlind2B:
_DAC8_2_WriteBlind2B:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DAC8_2_WriteStall
;  FUNCTION NAME: DAC8_2_WriteStall2B
;
;  DESCRIPTION:
...
_DAC8_2_Stop:
    RAM_PROLOGUE RAM_USE_CLASS_1
    and  reg[DAC8_2_MSB_CR3], ~bPWRMASK
    and  reg[DAC8_2_LSB_CR3], ~bPWRMASK
    RAM_EPILOGUE RAM_USE_CLASS_1
    ret
.ENDSECTION
; End of File DAC8_2.asm
